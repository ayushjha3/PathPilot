        ...
        <div className="relative">
          ...
          <div className="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
            ...
            <div>
              ...
              <h1 className="gradient-title text-5xl font-extrabold leading-tight md:text-6xl">
              ...
              <p className="mt-6 max-w-2xl text-lg leading-8 text-muted-foreground">
                Review your AI-generated cover letter before using it in
                your job application. You can copy, download, or further
                customize it to perfectly match the role.
              </p>
        ...
        <div className="mb-8 flex items-center gap-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Carefully review your generated cover letter before
